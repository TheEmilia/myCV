    ...
    M = function (e, t, n, a, i, s) {
      ...
      return (
        (u =
          ...
          h.join("") +
          "</select></div>"),
        c.showMonthAfterYear ? (m += u + d) : (m += d + u),
        ...
        (l._onInputChange = function (n) {
          ...
          n.firedBy !== l &&
            ((a = d.parse
              ...
              : t
              ? (a = e(d.field.value, d.format, d.formatStrict)) && a.isValid()
                ? a.toDate()
                : null
      ...
      render: function (e, t, n) {
        ...
        for (var x = !1, R = 0, N = 0; R < v; R++) {
          var S = new Date(e, t, R - o + 1),
            ...
            O = t,
            j = e,
            A = a.startRange && g(a.startRange, S),
            W = a.endRange && g(a.endRange, S),
            F =
          ...
          a.pickWholeWeek && C && (x = !0),
            l.push(_(P)),
            7 == ++N &&
              (a.showWeekNumber && l.unshift(b(R - o, t, e)),
